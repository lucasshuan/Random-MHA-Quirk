...
const REGISTER_DEFS: SelectedFusionNameRegister[] = [
  ...
  },
  {
    ...
    examples: ['Hellflame', 'Wave Motion', 'Foldabody', 'Heaven-Piercing Ice', 'Detonation'],
  },
  {
    key: 'absurd-long',
    instruction:
      'Ridiculously long or specific phrase — commit to the bit. 4+ words is fine if it stays funny or memorable.',
    examples: [
      'Gigantic Spinning Flying Turtle',
      'Beams From His Eyes',
  ...
  },
  {
    ...
    examples: ['Sugar Rush', 'Brainwashing', 'Navel Laser', 'Tape'],
  },
]
