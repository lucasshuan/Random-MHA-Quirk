...
export const es: Messages = {
  ...
  meta: {
    ...
    facetTip: {
      ...
      Support: 'Ayuda práctica del efecto central—sin curación ni buff gratis',
      Defense: 'Bloquear, absorber o reducir el daño recibido',
      Mobility: 'Movimiento, reposicionamiento o desplazamiento',
      Sensory: 'Percepción o retroalimentación del mecanismo del don',
      Construct: 'Objetos o estructuras creadas o cultivadas',
