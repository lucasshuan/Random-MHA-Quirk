/**
 * Aplica research/name-overrides-pt.json em manual-copy e pt-BR.ts
 */
...
const overrides = JSON.parse(
  readFileSync(join(root, 'research', 'name-overrides-pt.json'), 'utf8'),
)

const manualPath = join(root, 'research', 'manual-copy.json')
...
const ptPath = join(root, 'src', 'i18n', 'quirks', 'pt-BR.ts')
