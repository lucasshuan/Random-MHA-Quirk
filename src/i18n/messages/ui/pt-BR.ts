...
export const ptBR: Messages = {
  ...
  meta: {
    ...
    facetTip: {
      ...
      Support: 'Ajuda prática do efeito central—sem cura ou buff grátis',
      Defense: 'Bloquear, absorver ou reduzir dano recebido',
      Mobility: 'Movimento, reposicionamento ou deslocamento',
      Sensory: 'Percepção ou retorno do mecanismo da individualidade',
      Construct: 'Objetos ou estruturas criadas ou cultivadas',
